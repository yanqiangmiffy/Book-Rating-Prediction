...
from gen_feas_v2 import load_data
...
test['Book-Rating']=test['Book-Rating'].map(label)
score = np.mean(result_dict_lgb['scores'])
print(score)
test['id'] = test['id'].astype(int)
test[['id', 'Book-Rating']].to_csv('result/lgbv2_{}.csv'.format(score), index=None, header=None)
