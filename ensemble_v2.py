...
lgb3 = pd.read_csv('models/' + 'lgb_numclasses3_0.7305763829658076trainoof.csv', header=None)
...
lgb3_test = pd.read_csv('models/' + 'lgb_numclasses3_0.7305763829658076testoof.csv', header=None)
...
cat3 = pd.read_csv('models/' + 'cat_numclasses3_0.7384694273290521trainoof.csv', header=None)
...
cat3_test = pd.read_csv('models/' + 'cat_numclasses3_0.7384694273290521testoof.csv', header=None)
...
xgb3 = pd.read_csv('models/' + 'xgb_numclasses3_0.735611181829417trainoof.csv', header=None)
...
xgb3_test = pd.read_csv('models/' + 'xgb_numclasses3_0.735611181829417testoof.csv', header=None)
